                        ...
                        <div class="card-body">
                            ...
                            <div class="progress mt-2" style="height: 6px;">
                                <div class="progress-bar bg-danger" role="progressbar"
                                    style="width: {{ $activeTables > 0 ? ($occupiedTables / $activeTables) * 100 : 0 }}%">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($latestOrders as $order)
                                <tr>
                                    ...
                                    <td><span
                                            class="badge bg-label-secondary text-dark">{{ $order->table->name ?? 'N/A' }}</span>
                                    </td>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof ApexCharts === 'undefined') {
                ...
                document.querySelector("#salesChart").innerHTML =
                    '<div class="alert alert-danger">Error: No se pudo cargar la librería de gráficas. Verifique su conexión a internet.</div>';
                return;
            }
            ...
            try {
                ...
                document.querySelector("#salesChart").innerHTML =
                    '<div class="text-danger">Error rendering chart: ' + e.message + '</div>';
            }
        });
    </script>
@endpush
