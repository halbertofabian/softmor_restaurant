    ...
    <div class="card-body">
        <form action="{{ route('preparation-areas.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name="name" required placeholder="Ej. Cocina" autofocus>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="printer_name" name="printer_name" placeholder="Ej: EPSON-KITCHEN (Dejar vacío para usar default)">
